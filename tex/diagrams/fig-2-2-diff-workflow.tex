\begin{tikzpicture}[
    ...
    box/.style={draw, rounded corners=2pt, minimum height=9mm, text width=24mm, align=center, font=\small},
...
\node[phase] (phaseA) at (0,0) {Compile + static-init (before \texttt{main()})};
...
\node[phase, below=16mm of phaseA.south west, anchor=north west] (phaseB) {Runtime (in \texttt{main()})};
